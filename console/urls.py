...
from console.views import signin_u,signin_p,signup_,signup__,handleuser,signup___,signup____,validate_user,handleuserproducts,otp_verification,products
...
urlpatterns = [
    ...
    path('handleuser/<str:Email>',handleuser.as_view()),
